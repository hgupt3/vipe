...
class GraphBuffer:
    def __init__(
        ...
        self.fov_min_degrees = fov_min_degrees
        self.fov_max_degrees = fov_max_degrees
    ...
    def bundle_adjustment(
        ...
        solver.set_retractor("intrinsics", IntrinsicsRetractor(
            self.camera_type,
            image_height=self.height,
            fov_min_degrees=self.fov_min_degrees,
            fov_max_degrees=self.fov_max_degrees,
        ))
